...
//   const [cart, setCart] = useState({ items: [], totalPrice: 0 }); // Initialize with empty cart
...
//   useEffect(() => {
//     // Only initialize checkout if auth is loaded and user is authenticated
//     if (!authLoading) {
//       if (!isAuthenticated) {
...
//       // Get cart - handle case where cart might be null or empty
...
//       if (saveAddress && user) {
//         try {
//           // You might need to implement updateAddress in your authService
...
//                           className={`p-6 border rounded-2xl cursor-pointer transition-all ${selectedShipping?._id === method._id ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-pink-300'}`}
//                         >
//                           <div className="flex justify-between items-center">
//                             <div className="flex items-center">
//                               <div className={`w-4 h-4 rounded-full border-2 ${selectedShipping?._id === method._id ? 'border-pink-500 bg-pink-500' : 'border-gray-300'}`} />
//                               <div className="ml-4">
...
//                       className={`p-6 border rounded-2xl cursor-pointer transition-all ${selectedPayment === 'card' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-pink-300'}`}
//                     >
//                       <div className="flex items-center">
//                         <div className={`w-4 h-4 rounded-full border-2 ${selectedPayment === 'card' ? 'border-pink-500 bg-pink-500' : 'border-gray-300'}`} />
//                         <div className="ml-4">
//                           <h3 className="font-semibold text-gray-900">
//                             Credit/Debit Card
//                           </h3>
...
//                       className={`p-6 border rounded-2xl cursor-pointer transition-all ${selectedPayment === 'paypal' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-pink-300'}`}
//                     >
//                       <div className="flex items-center">
//                         <div className={`w-4 h-4 rounded-full border-2 ${selectedPayment === 'paypal' ? 'border-pink-500 bg-pink-500' : 'border-gray-300'}`} />
//                         <div className="ml-4">
//                           <h3 className="font-semibold text-gray-900">
//                             PayPal
//                           </h3>
...
//                       className={`p-6 border rounded-2xl cursor-pointer transition-all ${selectedPayment === 'cod' ? 'border-pink-500 bg-pink-50' : 'border-gray-200 hover:border-pink-300'}`}
//                     >
//                       <div className="flex items-center">
//                         <div className={`w-4 h-4 rounded-full border-2 ${selectedPayment === 'cod' ? 'border-pink-500 bg-pink-500' : 'border-gray-300'}`} />
//                         <div className="ml-4">
//                           <h3 className="font-semibold text-gray-900">
//                             Cash on Delivery
//                           </h3>
